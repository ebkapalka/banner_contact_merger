...
class GoodDriver(BannerDriver):
    ...
    def main_loop(self) -> None:
        ...
        update_input_value(self, v["ZIP or Postal Code"]['element'], "12345")
        update_input_value(self, v["Area Code"]['element'], "123")
        update_input_value(self, v["Phone Number"]['element'], "4567890")
        update_input_value(self, v["Address Verified"]['element'], "checked")
        update_input_value(self, v["From Date"]['element'], "01/22/1997")
        # update_input_value(self, "Nonexistent Field", "some text")
        # update_input_value(self, v["Skip Address Verify"]['element'], "true")
        v = extract_input_values(self)
