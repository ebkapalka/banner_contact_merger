...
class BannerDriver:
    ...
    def _enter_credentials(self):
        ...
        input_username = WebDriverWait(driver, self.timeout).until(
            EC.visibility_of_element_located((By.ID, "username")))
        input_password = WebDriverWait(driver, self.timeout).until(
            EC.visibility_of_element_located((By.ID, "password")))
        button_submit = WebDriverWait(driver, self.timeout).until(
